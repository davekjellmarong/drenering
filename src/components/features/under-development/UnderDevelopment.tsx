...
export default function UnderConstruction({
  ...
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-20 bg-brand-50/50">
      <div className="max-w-md w-full mx-auto text-center px-4">
        <div className="bg-white rounded-xl shadow-sm p-8 border border-brand-100">
          <div className="flex justify-center mb-6">
            <div className="bg-brand-100 p-4 rounded-full">
              <Construction className="h-12 w-12 text-brand-600" />
            </div>
          </div>
